-- Ensure is_admin function exists with correct signature/name (no drop to preserve dependencies)
...
-- Carbon calculations table (idempotent)
...
-- Auto-assign user_id on insert (uses existing public.set_auth_user_id)
